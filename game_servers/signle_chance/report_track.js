...
module.exports.test_win_tracks = async () => {
	let play_amount = 70,
		win_amount = 90;
	let client = {
		_id: "62ce9b5408d46268f50fe38e",
	};
	let commission = this.win_tracks(play_amount, win_amount, 0, client);
	csl("test_win  commission : ", commission);
	return true;
};
...
module.exports.add_commission = async (play_amount, client) => {
	...
	scl("add_commission commisions_info : ", commisions_info);
