...
const LuckyCard12PlayingsSchema = new Schema(
	{
		user_id: { type: mongoose.Schema.Types.ObjectId, ref: GameUser },
		game_id: { type: String, default: "" },
		game_type: { type: String, default: "lucky_cards_12" },
...
const LuckyCard12Playings = mongoose.model(
	"lucky_cards_12_playing",
	LuckyCard12PlayingsSchema
);
module.exports = LuckyCard12Playings;
