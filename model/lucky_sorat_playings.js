...
const LuckySoratPlayingsSchema = new Schema(
	{
		...
		game_config: {
			...
			REWARD_NORMAL: { type: Number, default: 50 },
			DRAW_TIME: { type: Number, default: 60 },
			SPIN_TIME: { type: Number, default: 2 },
...
const LuckySoratPlayings = mongoose.model(
	"lucky_sorat_playing",
	LuckySoratPlayingsSchema
);
module.exports = LuckySoratPlayings;
