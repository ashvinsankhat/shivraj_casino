...
const LuckyCardPlayingsSchema = new Schema(
	{
		user_id: { type: mongoose.Schema.Types.ObjectId, ref: GameUser },
		game_id: { type: String, default: "" },
		game_type: { type: String, default: "lucky_cards_16" },
...
const LuckyCardPlayings = mongoose.model(
	"lucky_cards_playing",
	LuckyCardPlayingsSchema
);
module.exports = LuckyCardPlayings;
