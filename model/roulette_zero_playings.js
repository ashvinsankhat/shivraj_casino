...
const rouletteZeroPlayingsSchema = new Schema(
	{
		user_id: { type: mongoose.Schema.Types.ObjectId, ref: GameUser },
		game_id: { type: String, default: "" },
		game_type: { type: String, default: "roulette_zero" },
...
const RouletteZeroPlayings = mongoose.model(
	"roulette_zero_playing",
	rouletteZeroPlayingsSchema
);
module.exports = RouletteZeroPlayings;
