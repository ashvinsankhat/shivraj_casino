...
const RoulettePlayingsSchema = new Schema(
	{
		...
		game_config: {
			...
			SPIN_TIME: { type: Number, default: 6 },
...
const RoulettePlayings = mongoose.model(
	"roulette_playing",
	RoulettePlayingsSchema
);
module.exports = RoulettePlayings;
