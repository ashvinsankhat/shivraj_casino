...
module.exports.place_bet = async (requestData, client) => {
	try {
		...
		let gameInfos = await SingleChancePlayings.findOne({}, {}).lean();
		...
		let gameInfo = await SingleChancePlayings.findOneAndUpdate({}, updateData, {
			new: true,
		});
		...
		bet_info["game_type"] = "single_chance";
