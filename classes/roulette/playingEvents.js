...
module.exports.eventHandler = async(en, requestData, client)=>{
    ...
    switch (en) {
        ...
        case 'ROULETTE_REPEAT_BET':
            betInfo.repeat_bet(requestData, client);
            break;

        case 'ROULETTE_GAME_HISTORY':
