...
module.exports.place_bet = async (requestData, client) => {
	try {
		...
		let gameInfos = await LuckyCard12Playings.findOne({}, {}).lean();
		...
		let gameInfo = await LuckyCard12Playings.findOneAndUpdate({}, updateData, {
			new: true,
		});
		...
		bet_info["game_type"] = "lucky_cards_12";
