module.exports.get_game_info = async(requestData, client) => {
    try{
        if(typeof client._id == "undefined"){
            respSendActions.SendDataToDirect(client.sck_id, 'LUCKY_SORAT_GAME_INFO', requestData , true, "1000" , "User session not set, please restart game!", "Error!");
            return true;
        }
        ...
        respSendActions.SendDataToUser(client, 'LUCKY_SORAT_GAME_INFO', gameInfo);
...
module.exports.close_game = async(requestData, client) => {
    try{
        ...
        respSendActions.SendDataToUser(client, 'LUCKY_SORAT_CLOSE_GAME', {
            done : true
        });
...
module.exports.auto_on_off = async(requestData, client) => {
    try{
        if(typeof client._id == "undefined"){
            respSendActions.SendDataToDirect(client.sck_id, 'LUCKY_SORAT_AUTO_ON_OFF', requestData , true, "1000" , "User session not set, please restart game!", "Error!");
            return true;
        }
        ...
        respSendActions.SendDataToUser(client, 'LUCKY_SORAT_AUTO_ON_OFF', {
...
module.exports.get_specific_game_info = async(requestData, client) => {
    try{
        if(typeof client._id == "undefined"){
            respSendActions.SendDataToDirect(client.sck_id, 'LUCKY_SORAT_GAME_SPECIFIC_INFO', requestData , true, "1000" , "User session not set, please restart game!", "Error!");
            return true;
        }
        let wh = {
        ...
        respSendActions.SendDataToUser(client, 'LUCKY_SORAT_GAME_SPECIFIC_INFO', gameBetInfo);
        return false
    }catch(e) {
