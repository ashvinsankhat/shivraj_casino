module.exports.get_game_list = async(requestData, client) => {
    try{
        if(typeof client._id == "undefined"){
            respSendActions.SendDataToDirect(client.sck_id, 'SINGLE_CHANCE_3D_GAME_HISTORY', requestData , true, "1000" , "User session not set, please restart game!", "Error!");
            return true;
        }
        ...
        respSendActions.SendDataToUser(client, 'SINGLE_CHANCE_3D_GAME_HISTORY', response);
...
module.exports.get_report = async(requestData, client) => {
    try{
        if(typeof client._id == "undefined"){
            respSendActions.SendDataToDirect(client.sck_id, 'SINGLE_CHANCE_3D_REPORT', requestData , true, "1000" , "User session not set, please restart game!", "Error!");
            return true;
        }
        ...
        respSendActions.SendDataToUser(client, 'SINGLE_CHANCE_3D_REPORT', response);
